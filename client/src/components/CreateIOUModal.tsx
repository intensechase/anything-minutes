              ...
              {mode === 'invite' ? (
                <div className="space-y-3 p-3 bg-dark rounded-lg">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-card border border-light/20 rounded-lg text-sm text-light placeholder-light/80 focus:outline-none focus:ring-2 focus:ring-accent/50"
                  />
                  <input
                    type="text"
